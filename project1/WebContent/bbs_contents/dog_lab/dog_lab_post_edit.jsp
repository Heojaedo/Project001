...
String code_edit = request.getParameter("code"); //lounge_view에서 받은 값(dog_lab);
...
<form action="dog_lab_post_edit_insert.jsp" method="post" enctype="multipart/form-data" onsubmit="return lounge_write()">
