...
<form action="/member/pro_login_insert.jsp" method="post" onsubmit="return pro_login_insert()">
...
<td>
	<table width=300px align=center border=0>
		...
		<tr>
			<td>
				<input class="td_login_input" type="text" id="id" name="id" value="<%=save_id %>">
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td>
				<input type="checkbox" name="id_save" <%if(!save_id.equals("")) {%>checked<%}%>> 아이디 저장
			</td>
		</tr>
	</table>
</td>
