...
<form action="/member/pro_pass_find_email.jsp" method="post" onsubmit="return id_check()">
...
<td>
	<table width=380px border=0 align=center>
		...
		<tr>
			<td class="td_pass_find_text">비밀번호를 찾고자 하는 아이디를 입력해주세요.</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td align=center>
				<input class="td_pass_find_input" type="text" id="id" name="id" value="">
			</td>
		</tr>
	</table>
</td>
