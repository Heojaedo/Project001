...
String code = request.getParameter("code"); //header에서 받은 값 (lounge)
...
<table width=1100px border=0 align=center>
	<tr>
		<td class="td_title">
		<a href="/bbs_community/commu_main.jsp?code=poppy_lounge" class="link_lounge"><span class="span_title">라운지</span></a>
		&nbsp;&nbsp;&nbsp;
		<a href="/bbs_community/commu_main.jsp?code=poppy_qna" class="link_qna"><span class="span_title">Q&A</span></a>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan=2>
			<div class="div_category">
				<div class="div_0"><%if(category_num == null) { %><img class="img_samsek" src="/img/samsek08.png" width=60px><%} %><a href="/bbs_community/commu_main.jsp?code=<%=code %>">전체</a></div>
				<div class="div_1"><%if(category_num != null && category_num.equals("1")) { %><img class="img_samsek" src="/img/samsek08.png" width=60px><%} %><a href="/bbs_community/commu_main.jsp?code=<%=code %>&category=1">강아지</a></div>
				<div class="div_2"><%if(category_num != null && category_num.equals("2")) { %><img class="img_samsek" src="/img/samsek08.png" width=60px><%} %><a href="/bbs_community/commu_main.jsp?code=<%=code %>&category=2">고양이</a></div>
				<div class="div_3"><%if(category_num != null && category_num.equals("3")) { %><img class="img_samsek" src="/img/samsek08.png" width=60px><%} %><a href="/bbs_community/commu_main.jsp?code=<%=code %>&category=3">소동물</a></div>
				<div class="div_4"><%if(category_num != null && category_num.equals("4")) { %><img class="img_samsek" src="/img/samsek08.png" width=60px><%} %><a href="/bbs_community/commu_main.jsp?code=<%=code %>&category=4">기타</a></div>
			</div>
		</td>
	</tr>
</table>
			...
			%>
				<table class="tb_post" width=1000px height=165px border=0 align=center>
					...
					<tr height=50px>
						...
						<a href="commu_lounge/lounge_view.jsp?code=<%=code %>&post=<%=rs.getInt("uid") %>"><%=rs.getString("title") %></a>
						</span>
						&nbsp;&nbsp;
						<%if(a-b <= 10000) { %>
					...
					<tr height=40px>
						...
						<a href="commu_lounge/lounge_view.jsp?code=<%=code %>&post=<%=rs.getInt("uid") %>" id="contents_link">
						<%=contents %>
						</a>
						</span>
						</td>
			...
			%>
				<table class="tb_post" width=1000px height=165px border=0 align=center>
					...
					<tr height=50px>
						...
						<td class="td_post_title" colspan=4 width=800px>
						<span class="span_post_title">
						<a href="commu_lounge/lounge_view.jsp?code=<%=code %>&post=<%=cate_rs.getInt("uid") %>"><%=cate_rs.getString("title") %></a>
						</span>
						&nbsp;&nbsp;
						<%if(a-b <= 10000) { %>
							<img src="img/main_new.gif">
					...
					<tr height=40px>
						...
						<td class="td_post_contents" colspan=4 width=800px>
						<span class="span_contents">
						<a href="commu_lounge/lounge_view.jsp?code=<%=code %>&post=<%=cate_rs.getInt("uid") %>" id="contents_link">
						<%=contents %>
						</a>
						</span>
						</td>
					...
					<tr height=25px>
						...
						<td width=100px align=center>
							<div class="div_post_category">
								<%if(cate_rs.getString("category").equals("1")) { //카테고리가 1일 때 %>
									강아지
								<%} else if(cate_rs.getString("category").equals("2")) { //카테고리가 2일 때 %>
									고양이
								<%} else if(cate_rs.getString("category").equals("3")) { //카테고리가 3일 때 %>
									소동물
								<%} else { %>
									기타
								<%} %>
...
<table width=1100px border=0 align=center>
	<tr>
		<td align=center>
			<input class="btn_write" type="button" value="글쓰기" onclick="location.href='commu_lounge/lounge_write.jsp?id=<%=id %>&code=<%=code %>'">
		</td>
	</tr>
</table>
<div style="height: 20px">
