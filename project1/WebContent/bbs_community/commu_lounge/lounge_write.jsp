...
<table class="write_table" width=1100px border=1 align=center>
	...
	<tr>
		<td class="td_cate_radio">
			<input type="radio" id="category" name="category" value="1" checked> 강아지
			<input type="radio" id="category" name="category" value="2"> 고양이
			<input type="radio" id="category" name="category" value="3"> 소동물
			<input type="radio" id="category" name="category" value="4"> 기타
		</td>
	</tr>
	<tr>
		<td align=center>
			<input class="input_title" type="text" id="title" name="title" value="" maxlength="30" placeholder="제목">
		</td>
	</tr>
	<tr>
		<td align=center>
