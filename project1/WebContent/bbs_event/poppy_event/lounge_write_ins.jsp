...
String sql = "insert into "+code+" (uid,memberid,nickname,title,contents,signdate,signdate2,startdate,enddate,category,loungefile,loungefile_o) values (null,'"+id+"','"+nick+"','"+title+"','"+contents+"','"+signdate+"','"+signdate2+"','"+startdate+"','"+enddate+"','"+category+"','"+loungefile_rename+"','"+loungefile_name+"')";
...
<script>
	location.href="/bbs_event/commu_main.jsp?code=<%=code %>&category=1";
</script>