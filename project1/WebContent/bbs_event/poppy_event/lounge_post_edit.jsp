...
<table class="write_table" width=1100px border=1 align=center>
	...
	<tr>
		<td class="td_cate_radio">
			<input type="radio" id="category" name="category" value="1" <%if(rs_edit.getString("category").equals("1")) {%>checked<%}%>> 진행 중인 이벤트
			<input type="radio" id="category" name="category" value="2" <%if(rs_edit.getString("category").equals("2")) {%>checked<%}%>> 종료된 이벤트
		</td>
	</tr>
	<tr>
		<td align=center>
	...
	<tr>
		<td style="text-indent: 48px;">
			<input class="input_date" type="date" id="startdate" name="startdate" value="<%= rs_edit.getString("startdate")%>">
			<input class="input_date" type="date" id="enddate" name="enddate" value="<%= rs_edit.getString("enddate")%>">
		</td>
	</tr>
	<tr>
		<td align=center>
